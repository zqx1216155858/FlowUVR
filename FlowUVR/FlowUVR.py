...
class CycleOTFlow(torch.nn.Module):
    def __init__(self,  pretrained_path=None, ckpt_folder="checkpoints", lora_rank_unet=8,
                 lora_rank_vae=4):
        super().__init__()
    ...
    @staticmethod
    def forward_with_networks(x,  unet,  sched, timesteps, text_emb):

        model_pred = unet(x, timesteps, encoder_hidden_states=text_emb, ).sample
