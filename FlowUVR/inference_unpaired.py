...
from FlowUVR import CycleOTFlow

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--input_image', type=str, default=None,required=True, help='path to the input image')
    parser.add_argument('--prompt', type=str, default='a snowy image',required=False, help='the prompt to be used. It is required when loading a custom model_path.')
    parser.add_argument('--model_name', type=str, default='snowy2clear', help='name of the pretrained model to be used')
    ...
    model = CycleOTFlow(pretrained_name=args.model_name, pretrained_path=args.model_path)
    model.eval()
